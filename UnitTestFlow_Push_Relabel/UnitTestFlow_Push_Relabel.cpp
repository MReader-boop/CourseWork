...
namespace UnitTestFlowPushRelabel
{
	...
	public:
		...
		{
			ifstream input("C:\\Users\\klesovi\\Desktop\\Flow_Push_Relabel\\UnitTestFlow_Push_Relabel\\Input1.txt");
			Flow flow(input);
			Assert::AreEqual(flow.max_flow(), 5);
		}
		TEST_METHOD(TestMethod_Exception_entering_the_first_character) {
			try {
				ifstream input("C:\\Users\\klesovi\\Desktop\\Flow_Push_Relabel\\UnitTestFlow_Push_Relabel\\Input2.txt");
				Flow flow(input);
			}
			catch (exception & ex) {
		...
		TEST_METHOD(TestMethod_Exception_entering_the_second_character) {
			try {
				ifstream input("C:\\Users\\klesovi\\Desktop\\Flow_Push_Relabel\\UnitTestFlow_Push_Relabel\\Input3.txt");
				Flow flow(input);
			}
			catch (exception & ex) {
		...
		TEST_METHOD(TestMethod_Exception_entering_the_third_number_flow) {
			try {
				ifstream input("C:\\Users\\klesovi\\Desktop\\Flow_Push_Relabel\\UnitTestFlow_Push_Relabel\\Input4.txt");
				Flow flow(input);
			}
			catch (exception & ex) {
		...
		TEST_METHOD(TestMethod_Exception_empty_string) {
			try {
				ifstream input("C:\\Users\\klesovi\\Desktop\\Flow_Push_Relabel\\UnitTestFlow_Push_Relabel\\Input5.txt");
				Flow flow(input);
			}
			catch (exception & ex) {
		...
		{
			ifstream input("C:\\Users\\klesovi\\Desktop\\Flow_Push_Relabel\\UnitTestFlow_Push_Relabel\\Input6.txt");
			Flow flow(input);
			Assert::AreEqual(flow.max_flow(), 25);
		}
		TEST_METHOD(TestMethod_Ñorrect_output_for_2_vertexes_edges_from_source_to_sink)
		{
			ifstream input("C:\\Users\\klesovi\\Desktop\\Flow_Push_Relabel\\UnitTestFlow_Push_Relabel\\Input7.txt");
			Flow flow(input);
			Assert::AreEqual(flow.max_flow(), 20);
		}
		TEST_METHOD(TestMethod_Exception_there_is_a_path_from_the_vertex_to_itself) {
			try {
				ifstream input("C:\\Users\\klesovi\\Desktop\\Flow_Push_Relabel\\UnitTestFlow_Push_Relabel\\Input8.txt");
				Flow flow(input);
			}
			catch (exception & ex) {
		...
		{
			ifstream input("C:\\Users\\klesovi\\Desktop\\Flow_Push_Relabel\\UnitTestFlow_Push_Relabel\\Input9.txt");
			Flow flow(input);
